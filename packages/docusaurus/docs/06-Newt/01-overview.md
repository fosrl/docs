...
Newt is used with Pangolin and Gerbil as part of the larger system.
...
Take a look at [this note](./02-install.md#unraid-portainer-and-other-uis) if your commands are not working.
